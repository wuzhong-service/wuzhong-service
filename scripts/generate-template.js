...
/** 标签活动（8.2-8.6）：档位对应品规和数量，支持任意档位列 */
function genPackages() {
  const r = (品牌组, 类型, 品规名称, tiers) => ({
    品牌组,
    品牌: ['组1','组2','组3','组4','组5','组6'].includes(品牌组) ? '江苏中烟' : 品牌组,
    类型, 品规名称,
    ...tiers,
    更新时间: today()
  })
  return [
    // 上烟集团
    r('上烟集团', '活动品规', '中华(硬红)', { '30-28档数量': 30, '27-20档数量': 20, '19-15档数量': 15, '14-10档数量': 8, '9-1档数量': 5 }),
    r('上烟集团', '激励品规', '利群(硬休闲银细支)', { '30-28档数量': 1 }),
    r('上烟集团', '激励品规', '牡丹(软)', { '30-28档数量': 15, '27-20档数量': 10, '19-15档数量': 8, '14-10档数量': 4, '9-1档数量': 3 }),
    r('上烟集团', '激励品规', '中华(硬双中支)', { '30-28档数量': 20, '27-20档数量': 15, '19-15档数量': 10, '14-10档数量': 5, '9-1档数量': 3 }),
    // 组1
    r('组1', '活动品规', '苏烟(软五星红杉树)', { '30-28档数量': 25, '27-20档数量': 22, '19-15档数量': 16, '14-10档数量': 10, '9-1档数量': 6 }),
    r('组1', '激励品规', '南京(硬炫赫门)', { '30-28档数量': 18, '27-20档数量': 16, '19-15档数量': 12, '14-10档数量': 7, '9-1档数量': 4 }),
    // 组2
    r('组2', '活动品规', '苏烟(软金砂)', { '30-28档数量': 24, '27-20档数量': 20, '19-15档数量': 10, '14-10档数量': 6, '9-1档数量': 2 }),
    r('组2', '激励品规', '南京(硬紫树)', { '30-28档数量': 24, '27-20档数量': 20, '19-15档数量': 10, '14-10档数量': 6, '9-1档数量': 2 }),
    r('组2', '激励品规', '红旗渠(银河之光)', { '30-28档数量': 12, '27-20档数量': 10, '19-15档数量': 5, '14-10档数量': 2, '9-1档数量': 1 }),
    // 组3
    r('组3', '活动品规', '南京(硬梦都)', { '30-28档数量': 21, '27-20档数量': 15, '19-15档数量': 12, '14-10档数量': 6, '9-1档数量': 3 }),
    r('组3', '激励品规', '南京(硬红)', { '30-28档数量': 7, '27-20档数量': 5, '19-15档数量': 4, '14-10档数量': 2, '9-1档数量': 1 }),
    // 组4
    r('组4', '活动品规', '南京(硬九五)', { '30-28档数量': 5, '27-20档数量': 4, '19-15档数量': 2 }),
    r('组4', '激励品规', '南京(硬紫树)', { '30-28档数量': 5, '27-20档数量': 4, '19-15档数量': 2 }),
    r('组4', '激励品规', '利群(硬新版)', { '30-28档数量': 5, '27-20档数量': 4, '19-15档数量': 2 }),
    // 组5
    r('组5', '活动品规', '南京(软九五)', { '30-28档数量': 5, '27-20档数量': 4, '19-15档数量': 2 }),
    r('组5', '激励品规', '南京(硬紫树)', { '30-28档数量': 5, '27-20档数量': 4, '19-15档数量': 2 }),
    r('组5', '激励品规', '利群(硬新版)', { '30-28档数量': 4, '27-20档数量': 3, '19-15档数量': 2 }),
    // 组6
    r('组6', '活动品规', '苏烟(五星红中)', { '30-28档数量': 20, '27-20档数量': 15, '19-15档数量': 10, '14-10档数量': 5, '9-1档数量': 3 }),
    r('组6', '激励品规', '南京(硬红)', { '30-28档数量': 15, '27-20档数量': 10, '19-15档数量': 7, '14-10档数量': 4, '9-1档数量': 2 }),
    // 云南中烟
    r('云南中烟', '活动品规', '玉溪(软)', { '30-28档数量': 22, '27-20档数量': 18, '19-15档数量': 12, '14-10档数量': 7, '9-1档数量': 4 }),
    r('云南中烟', '激励品规', '红塔山(软13mg经典1956)', { '30-28档数量': 22, '27-20档数量': 18, '19-15档数量': 12, '14-10档数量': 7, '9-1档数量': 4 }),
    // 湖南中烟
    r('湖南中烟', '活动品规', '芙蓉王(硬金)', { '30-28档数量': 2, '27-20档数量': 2, '19-15档数量': 2, '14-10档数量': 2, '9-1档数量': 2 }),
    r('湖南中烟', '激励品规', '白沙(硬新精品二代)', { '30-28档数量': 1, '27-20档数量': 1, '19-15档数量': 1, '14-10档数量': 1, '9-1档数量': 1 }),
    r('湖南中烟', '激励品规', '白沙(硬绿)', { '30-28档数量': 1, '27-20档数量': 1, '19-15档数量': 1, '14-10档数量': 1, '9-1档数量': 1 }),
    // 贵州工业
    r('贵州工业', '活动品规', '贵烟(硬细支国酒香30)', { '30-28档数量': 1, '27-20档数量': 1 }),
    r('贵州工业', '活动品规', '贵烟(硬红中支)', { '30-28档数量': 2, '27-20档数量': 2 }),
    r('贵州工业', '激励品规', '黄果树(硬长征)', { '30-28档数量': 6, '27-20档数量': 6 }),
    // 湖北中烟（档位有变化：仅30档、29-28档）
    r('湖北中烟', '活动品规', '黄鹤楼(平安)', { '30档数量': 18, '29-28档数量': 5 }),
    r('湖北中烟', '激励品规', '黄鹤楼(硬银紫)', { '30档数量': 20, '29-28档数量': 20 }),
    r('湖北中烟', '激励品规', '黄鹤楼(宝相细支)', { '30档数量': 1 }),
    r('湖北中烟', '激励品规', '黄鹤楼(九天)', { '30档数量': 1, '29-28档数量': 1 }),
  ]
}
...
addSheet(wb, '套餐信息', genPackages(), [10, 6, 12, 24, 12, 12, 12, 12, 12, 12, 12, 12])
